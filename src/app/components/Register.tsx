    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: "#0a0a0a" }}>
      ...
      >
        <div className="text-center mb-6">
          ...
          <p style={{ fontSize: 14, color: "#888888", marginTop: 4 }}>Create your account</p>
        </div>
        ...
        <p className="text-center" style={{ fontSize: 14, color: "#888888" }}>
          ...
          <button onClick={() => navigate("/login")} style={{ color: "#3b82f6", background: "none", border: "none", cursor: "pointer", fontSize: 14, fontWeight: 500 }}>
            Log in
          </button>
        </p>
      </div>
